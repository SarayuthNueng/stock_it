...
if ($_FILES['m_image']['name'] == '') {
	$sql2 = "INSERT INTO material (m_name,m_price,m_number,m_date,m_time,m_detail,m_s_id)
		VALUES('$m_name','$m_price','$m_number','$m_date','$m_time','$m_detail','$m_s_id')";
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.css">';
	...
	$sql = "INSERT INTO material (m_name,m_price,m_number,m_date,m_time,m_detail,m_image,m_s_id)
		VALUES('$m_name','$m_price','$m_number','$m_date','$m_time','$m_detail','$fileNewName','$m_s_id')";
