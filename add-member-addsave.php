...
if ($num > 0) {
    ...
    $sql = "INSERT INTO users (username, password, pname, fullname, cid, tel, txtoffice, position, ulevel, status) VALUES ('$username', '$password', '$pname', '$fullname', '$cid', '$tel', '$txtoffice', '$position', 'member', '$status') ";
